...
#
#     alipay = AliPay(
#         appid="2016092800614461",
#         app_notify_url= host+"alipay/return/",
#         app_private_key_path="../trade/keys/rsa_private_key.pem",
#         alipay_public_key_path="../trade/keys/alipay_key.txt",  # 支付宝的公钥，验证支付宝回传消息使用，不是你自己的公钥,
#         debug=True,  # 默认False,
#         return_url=host+"alipay/return/"
#     )
#
...
#         return_url=host+"alipay/return/"
#     )
#     re_url = "https://openapi.alipaydev.com/gateway.do?{data}".format(data1=url)
#
#     print(re_url)